...
class Calendar:
    ...
    def fields(self):
        return [
            ...
            self.__monday_cell.encoded_value_as_string(),
            self.__tuesday_cell.encoded_value_as_string(),
            self.__wednesday_cell.encoded_value_as_string(),
            self.__thursday_cell.encoded_value_as_string(),
            self.__friday_cell.encoded_value_as_string(),
            self.__saturday_cell.encoded_value_as_string(),
            self.__sunday_cell.encoded_value_as_string(),
        ]
